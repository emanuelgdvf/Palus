...
{className:"stage-2",title:"Primeiro impacto",text:"A madeira sofreu o primeiro golpe."},
{className:"stage-3",title:"Pequena rachadura",text:"Uma rachadura apareceu na madeira."},
{className:"stage-4",title:"Tronco rachado",text:"As rachaduras estão aumentando."},
{className:"stage-5",title:"Madeira danificada",text:"O tronco começa a perder sua resistência."},
{className:"stage-6",title:"Grandes rachaduras",text:"A madeira está começando a se partir."},
{className:"stage-7",title:"Tronco quebrado",text:"Grandes pedaços começam a se separar."},
{className:"stage-8",title:"Pedaço de madeira",text:"Agora restou apenas uma parte do tronco."},
{className:"stage-9",title:"Lasca grande",text:"A madeira continua diminuindo."},
{className:"stage-10",title:"Lasca de madeira",text:"Está ficando cada vez menor."},
{className:"stage-11",title:"Pequeno pedaço",text:"Já está começando a parecer um palito."},
{className:"stage-12",title:"Quase um palito",text:"Só mais alguns golpes..."},
...
{className:"stage-14",title:"Palito de dente",text:"🦷 Palito dropado! O RNG foi ativado."}
    ...
    const newWood = document.getElementById("newWood");
    ...
    function addToAuction() {
      ...
      renderAuction();
      showToast(`Lote ${auctionLots.length} entrou no leilão por ${money.format(currentPalito.value)}!`);
    ...
    function renderAuction() {
      lotCount.textContent = auctionLots.length;
    ...
    newWood.addEventListener("click", resetWood);
